...
alias tfls='tmuxifier load-session $(tmuxifier list-sessions | gum choose --header "Pick a session layout: " --header.foreground="114" --selected.foreground="204" --cursor.foreground="204" --item.foreground="231" --select-if-one)'
alias tfls='tmuxifier load-session $(tmuxifier list-sessions | gum filter --placeholder "Pick a session layout: ")'
alias sc='sesh connect $(sesh list -i -t | gum choose --header "Pick a session to connect: " --header.foreground="114" --selected.foreground="204" --cursor.foreground="204" --item.foreground="231" --select-if-one)'
