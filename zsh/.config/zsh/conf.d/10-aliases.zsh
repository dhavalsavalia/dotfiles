...
alias sc='sesh connect "$(basename "$PWD")"'  # Connect to session named after current dir
alias ss='sesh connect $(sesh list | gum filter --placeholder "Pick a session to connect: ")'  # Select any session
